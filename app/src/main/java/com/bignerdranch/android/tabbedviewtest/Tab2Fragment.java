...
public class Tab2Fragment extends android.support.v4.app.Fragment {
    ...
    private List<Article> mArticleDataset = new ArrayList<Article>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab2_main_recycler, container, false);
...
//        mAdapter = new Tab2Adapter(mArticleDataset, this);
        mAdapter = new Tab2Adapter(mArticleDataset, getContext());
    ...
    public void httpRequest(){
        String url = "http://raz-test.herokuapp.com/api/v1/others/get";
        ...
        client.get(url, new JsonHttpResponseHandler() { // Rz - Handles parsing the JSON data from the URL
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    mArticleDataset.clear(); // Rz. So that array does not keep on accumulating new Hotel Objects
                    for(int i = 0; i < dataArray.length(); i++) {
                        String title = dataArray.getJSONObject(i).getString("title");
                        String shortDescription = dataArray.getJSONObject(i).getString("description");
                        String fullDescription = dataArray.getJSONObject(i).getString("longer_description");
                        mArticleDataset.add(new Article(title, shortDescription, fullDescription));
                    }
